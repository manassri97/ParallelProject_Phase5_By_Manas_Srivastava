...
public class MyController {
	...
	@RequestMapping(method=RequestMethod.GET, value="/showCustomerClause/{min_balance}/{max_balance}")
	public List<Customer> showCustomerClause(@PathVariable BigDecimal min_balance,@PathVariable BigDecimal max_balance) {
		return walletServiceImpl.showCustomerClause(min_balance,max_balance);
	}
	
	@RequestMapping(method=RequestMethod.GET, value="/showCustomerByName/{name}")
	public List<Customer> showCustomerByName(@PathVariable String name) {
		return walletServiceImpl.showCustomerByName(name);
	}
	
	@RequestMapping(method=RequestMethod.GET, value="/showAllCustomer")
	public List<Customer> showAllCustomer() {

		return walletServiceImpl.showAllCustomer();
	}
